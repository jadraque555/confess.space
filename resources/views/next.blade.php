...
<div class="notification-green text-center bg-success p-2 rounded text-light">
✔ Message sent successfully 👍
</div>

<!-- <div class="tick">
<img src="/src/img/logo.png" alt="tick" style="width:75px;height:75px;border-radius:50%;">
</div> -->
<br/>
<h6>Now, create a link for yourself. See what your friends message you!</h6>
<br/>
